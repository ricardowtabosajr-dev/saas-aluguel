      ...
      <div className="w-full max-w-md bg-white rounded-[48px] shadow-2xl shadow-indigo-100/50 overflow-hidden border border-slate-100 animate-in zoom-in-95 duration-500">
        <div className="p-10 pb-6">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-black text-slate-900 tracking-tighter">Alpha Aluguéis de Roupas</h1>
            <p className="text-slate-400 mt-3 font-medium text-sm px-4">
              Acesso restrito para gestão da loja.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                ...
                <button type="button" className="text-[10px] font-black uppercase tracking-widest text-indigo-500 hover:text-indigo-700">Esqueci</button>
              </div>
              <input
                required
                type="password"
        ...
        <div className="p-8 bg-slate-50/50 border-t border-slate-100 text-center">
          <button
            ...
            className="group text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 hover:text-indigo-600 transition-colors flex items-center justify-center gap-2 mx-auto"
          >
